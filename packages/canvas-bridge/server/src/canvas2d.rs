...
//!
//! For fingerprinter-defeating output that matches real Chrome byte-for-byte we'd
...
/// RGBA is 256 MiB — far above anything fingerprinter-class probes ever create.
...
/// Skia uses for its quarter-arc tessellation; sufficient for the fingerprinter's
