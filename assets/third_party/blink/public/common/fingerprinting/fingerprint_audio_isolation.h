...
//
// Why: commercial fingerprinters and a fingerprinting test page both probe AudioContext / OfflineAudioContext
...
// commercial fingerprinters measures cancels out to the original value (the bug we
